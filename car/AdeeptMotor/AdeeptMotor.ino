...
//          ctrlCar1(135-(data[7] - 512) / 12,  FORWARD, spd);  // control steering and reversing smart car
//        else
//          ctrlCar1(45-(data[7] - 512) / 12,  FORWARD, spd);   // control steering and reversing smart car
//        for(int i=0;i<15;i++){
...
//        if (barDegree < 90)       // choose to reverse direction according to the angle with obstacle
//          ctrlCar1(135-(data[7] - 512) / 12, BACKWARD, spd);   // control steering and moving on
//        else
//          ctrlCar1(45-(data[7] - 512) / 12, BACKWARD, spd);    // control steering and moving on
//        for(int i=0;i<10;i++){
//        delay(100);              // reversing time
//        receiveData();
//        }
...
//        ctrlCar1(90-(data[7] - 512) / 12, BACKWARD, spd);      // control the smart car move on
//        for(int i=0;i<10;i++){
//        delay(100);              // reversing time
//        receiveData();
//        }
//      }
//      ctrlCar1(90-(data[7] - 512) / 12, BACKWARD, 0);   // make the smart car stop for preparation of next scanning
//   }
